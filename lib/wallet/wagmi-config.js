...
export const wagmiConfig = createConfig({
  ...
  ssr: false,
  // Preglyph owns wallet reconnect/disconnect persistence explicitly in session-storage.mjs.
  // Keep wagmi storage non-persistent so there is a single source of truth for session intent.
