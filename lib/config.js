...
export function getPublicRuntimeConfig() {
  return {
    ...
    chainName: process.env.NEXT_PUBLIC_PREGLYPH_CHAIN_NAME || (LOCAL_CHAIN_ID === 11155111 ? 'Sepolia' : LOCAL_CHAIN_ID === 1 ? 'Ethereum' : 'Preglyph Testchain'),
    currencySymbol: process.env.NEXT_PUBLIC_PREGLYPH_CURRENCY_SYMBOL || 'ETH',
    explorerBaseUrl:
      process.env.NEXT_PUBLIC_PREGLYPH_EXPLORER_BASE_URL ||
      (LOCAL_CHAIN_ID === 11155111 ? 'https://sepolia.etherscan.io/tx/' : LOCAL_CHAIN_ID === 1 ? 'https://etherscan.io/tx/' : ''),
